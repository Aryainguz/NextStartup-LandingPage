          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className="mb-9 rounded-[20px] bg-white dark:bg-dark-2 p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
                ...
                <p className="text-body-color dark:text-dark-6">
                  ...
                  experiences with our user friendly designs.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className="mb-9 rounded-[20px] bg-white dark:bg-dark-2 p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
                ...
                <p className="text-body-color dark:text-dark-6">
                  Unleash Lightning-Fast Performance. We provide effiecient and
                  fast solutions for your business.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className="mb-9 rounded-[20px] bg-white dark:bg-dark-2 p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
                ...
                <p className="text-body-color dark:text-dark-6">
                  Elevate your digital space with limitless customization
                  options. Tailor every detail to reflect your unique style and
                  preferences.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className="mb-9 rounded-[20px] bg-white dark:bg-dark-2 p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
                ...
                <p className="text-body-color dark:text-dark-6">
                  We provide full stack solutions for your business. From Company Website to E-Commerce we havve got you covered.
                </p>
              </div>
            </div>
          </div>
