...
const useClickOutside = (handler: Handler): React.RefObject<HTMLDivElement> => {
...
const Video: React.FC = () => {
  ...
  return (
    <>
    <br /><br /><br /><br/>
       <div className="mx-auto mt-20 max-w-[510px] text-center ">
                ...
                CapusLink Official Trailer
                </h2>
                <p className="text-gray-400 text-base ">
                Watch Official Trailer Video of CampusLink  
                </p>
              </div>
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 lg:w-10/12">
            <div className="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
              ...
              <div
                className={`absolute left-0 top-0 z-10 flex h-full w-full items-center justify-center bg-opacity-90`}
              >
                <a
                  onClick={() => setvideoOpen(true)}
                  className="absolute cursor-pointer z-20 flex h-20 w-20 items-center justify-center rounded-full bg-white text-primary dark:bg-dark-2 dark:text-white md:h-[100px] md:w-[100px]"
                >
          ...
          <div className="mx-auto w-full max-w-[550px] bg-white">
            <>
              <iframe
                ...
                src="https://www.youtube.com/embed/FT0Fggi3CWs?autoplay=1"
              />
            </>
          </div>
