...
const Cards = () => {
    ...
    return (
        <div id="blockchain">
            <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 mb-10 ">
                <div className="md:w-2/3 lg:w-1/2">
                    ...
                    <h2 className="my-8 text-2xl font-bold text-gray-700 dark:text-black md:text-4xl" data-aos="fade-up-right" data-aos-duration="1000" data-aos-once="true">
                        What You Need to Know :<br /><span className='text-purple-500'>Web3 Technology</span>
                    </h2>
                    <p className="text-gray-600 dark:text-black" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                      With the advent of Web3 technology, and with less trust amongst quality of what you expect, VeriTrust verifies the authenticity of the product with just a scan or a click and gets your trsut.
                    </p>
                </div>
                        ...
                        <div className="relative space-y-8 py-12 p-8">
                            ...
                            <div className="space-y-2" data-aos="fade-in" data-aos-duration="1000" data-aos-once="true">
                                ...
                                <p className="text-gray-600 dark:text-gray-300">
                                   With one touch scan it's convinient to verify the product even with something of a power of blockchain.
                                </p>
                            </div>
                    ...
                    <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                        <div className="relative space-y-8 py-12 p-8">
                            ...
                            <div className="space-y-2" data-aos="fade-in" data-aos-duration="1000" data-aos-once="true">
                                ...
                                <p className="text-gray-600 dark:text-gray-300">
                                  With power of unique blockchain hash of every project there's no copy of your product.
                                </p>
                            </div>
                            <a href="https://medium.com/@aryaninguz369/campuslink-connecting-campuses-empowering-students-977424e97cd5" className="flex items-center justify-between group-hover:text-secondary" target="_blank">
                                <span className="text-sm">Know more</span>
